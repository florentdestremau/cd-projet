...
class Client
{
    ...
    public function setContactEmail(?string $email): self { $this->contactEmail = $email; return $this; }
    ...
    public function setLinkedUser(?User $user): self { $this->linkedUser = $user; return $this; }
