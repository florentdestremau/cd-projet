...
class Stone
{
    ...
    public function setType(StoneType $t): self
    {
        $this->type = $t;
    ...
    public function getCaratWeight(): int
    {
        return $this->caratWeight;
    }

    public function setCaratWeight(int $w): self
    {
        $this->caratWeight = $w;
    ...
    public function setQuality(?string $q): self
    {
        $this->quality = $q;
    ...
    public function setColor(?string $c): self
    {
        $this->color = $c;
    ...
    public function getCertificateRef(): ?string
    {
        return $this->certificateRef;
    }

    public function setCertificateRef(?string $r): self
    {
        $this->certificateRef = $r;
    ...
    public function setCostPrice(int $p): self
    {
        $this->costPrice = $p;
